...
find_library(LIBFAT_LIBRARY NAMES libfat libfat.a
    PATHS ${LIBOGC_PATHS}
    PATH_SUFFIXES lib lib/wii)

find_library(LIBDB_LIBRARY NAMES libdb libdb.a
    PATHS ${LIBOGC_PATHS}
    PATH_SUFFIXES lib lib/wii)

set(LIBOGC_LIBRARIES ${LIBDB_LIBRARY} ${LIBWIIUSE_LIBRARY} ${LIBBTE_LIBRARY} ${LIBFAT_LIBRARY} ${LIBOGC_LIBRARY} )
