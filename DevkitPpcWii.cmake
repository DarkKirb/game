...
msys_to_cmake_path("$ENV{DEVKITARM}" DEVKITPPC)
...
if(WIN32)
    ...
    set(CMAKE_CXX_COMPILER "${DEVKITARM}/bin/powerpc-eabi-g++.exe")
    set(CMAKE_AR "${DEVKITARM}/bin/powerpc-eabi-gcc-ar.exe" CACHE STRING "")
    set(CMAKE_RANLIB "${DEVKITARM}/bin/powerpc-eabi-gcc-ranlib.exe" CACHE STRING "")
else()
    set(CMAKE_C_COMPILER "${DEVKITARM}/bin/powerpc-eabi-gcc")
    set(CMAKE_CXX_COMPILER "${DEVKITARM}/bin/powerpc-eabi-g++")
    set(CMAKE_AR "${DEVKITARM}/bin/powerpc-eabi-gcc-ar" CACHE STRING "")
    set(CMAKE_RANLIB "${DEVKITARM}/bin/powerpc-eabi-gcc-ranlib" CACHE STRING "")
endif()

set(WITH_PORTLIBS ON CACHE BOOL "use portlibs ?")

if(WITH_PORTLIBS)
    set(CMAKE_FIND_ROOT_PATH ${DEVKITARM} ${DEVKITPRO} ${DEVKITPRO}/portlibs/wii ${DEVKITPRO}/portlibs/ppc)
else()
